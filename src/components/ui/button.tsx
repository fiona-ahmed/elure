  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-luxury focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        luxury: "bg-luxury text-luxury-foreground shadow-luxury hover:shadow-elegant transform hover:scale-[1.02]",
        "luxury-outline": "border-2 border-luxury text-luxury bg-transparent hover:bg-luxury hover:text-luxury-foreground transition-luxury",
        hero: "bg-luxury text-luxury-foreground hover:bg-luxury/90 shadow-elegant transform hover:scale-[1.02] font-medium",
      },
      size: {
